...
<!-- Signatory Block -->
@if($gpoa->status === 'approved' || $gpoa->status === 'stored')
<div class="bg-white rounded-xl shadow-sm border overflow-hidden">
    <div class="px-6 py-4 bg-gray-50 border-b">
        <h3 class="font-bold text-gray-800">Signatories</h3>
    </div>
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <!-- Prepared By -->
            <div class="text-center">
                <p class="text-xs text-gray-500 uppercase tracking-wide mb-12">Prepared by</p>
                <p class="text-xs text-gray-600 min-h-6 pb-2">{{ $gpoa->prepared_by ?? '' }}</p>
                <div class="border-t-2 border-gray-800 pt-2">
                    <p class="text-xs text-gray-600">Organization Officer</p>
                </div>
            </div>

            <!-- Attested By (Adviser) -->
            <div class="text-center">
                <p class="text-xs text-gray-500 uppercase tracking-wide mb-12">Attested by</p>
                <p class="text-xs text-gray-600 min-h-6 pb-2">___________________</p>
                <div class="border-t-2 border-gray-800 pt-2">
                    <p class="text-xs text-gray-600">Adviser/Coordinator</p>
                </div>
            </div>

            <!-- Noted By -->
            <div class="text-center">
                <p class="text-xs text-gray-500 uppercase tracking-wide mb-12">Noted by</p>
                <p class="text-xs text-gray-600 min-h-6 pb-2">___________________</p>
                <div class="border-t-2 border-gray-800 pt-2">
                    <p class="text-xs text-gray-600">OSDW Coordinator</p>
                </div>
            </div>

            <!-- Approved By -->
            <div class="text-center">
                <p class="text-xs text-gray-500 uppercase tracking-wide mb-12">Approved by</p>
                <p class="text-xs text-gray-600 min-h-6 pb-2">{{ $gpoa->approver?->name ?? '___________________' }}</p>
                <div class="border-t-2 border-gray-800 pt-2">
                    <p class="text-xs text-gray-600">Campus Executive Officer</p>
                </div>
            </div>
        </div>
    </div>
